...
Jusqu'à présent, rien n'est écrit sur disque, tout est en mémoire. Les données
sont récupérées, et transitent donc sur le réseau lorsqu'on fait un get_data()
et les paramètres de la 'query' du get_data() filtrent et sélectionnent les
